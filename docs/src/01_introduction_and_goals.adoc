...
.2+|**Equipo de desarrolladores** | Iyán Iglesias Ibaseta (https://github.com/iyaniglesias) 
.2+|Desarrollar YOVI con las herramientas adecuadas, cumpliendo los requisitos y asegurando que permita a los usuarios competir y conseguir una puntuación en base a la partida jugada.
