...
* **MongoDB:** base de datos no relacional. Más intuitiva y sencilla de montar en el servidor, además de estar orientada a JSON.
...
* **GitHub:** servicio basado en la nube donde se subirán las distintas versiones, cambios, reuniones, decisiones, … en torno a la aplicación.
