...
Estos test se ejecutaron de forma local desde la carpeta /users/__test__ con el comando **> npx vitest run --reporter=tree**, y de ahí se han tomado las capturas, excepto en el test de coverage.
