...
describe('POST /loginuser', () => {
    ...
    */
    it('abre la página principal con el usuario creado', async () => {
        ...
        await setup('Test_Username_Login_Bien', 'Test_Password1')

        const res = await request(app)
        .post('/loginuser')
        .send({
            username: 'Test_Username_Login_Bien',
        ...
        expect(res.body.message).toMatch("Sesión iniciada con Test_Username_Login_Bien.")

        await takedown('Test_Username_Login_Bien')
    })
    ...
    */
    it('salta error por contraseña incorrecta', async () => {
        ...
        await setup('Test_Username_Login_Mal', 'Test_Password1')

        const res = await request(app)
        .post('/loginuser')
        .send({
            username: 'Test_Username_Login_Mal',
        ...
        await takedown('Test_Username_Login_Mal')
    })
